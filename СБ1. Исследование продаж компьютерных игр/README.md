...
# Ниже я представил План работ, описание данных, используемые Инструменты и Ход моей работы:
...
### (С полной моей работой Вы можете ознакомиться в файле под названием "Исследование продаж компьютерных игр", хранящемся в данной папке.
